  ...
  <div :class="!transparency || !topOfPage || dropdownopen ? 'navbar scrolled' : 'navbar normal'">
    ...
    <div class="navitems">
      ...
      <div class="nav">
        <ul v-if="inStore && screenWidth > 700">
          ...
          <li><router-link v-if="!visible" to="/cart">Korpa</router-link></li>
          <li><router-link to="/chat">Poruke</router-link></li>
          <li><router-link v-if="!visible" to="/shopcontact">Kontakt</router-link></li>
          <li><router-link v-if="visible" to="/adminPage">Korisnici</router-link></li>
          <li><router-link v-if="visible" to="/servicesPage">Usluge</router-link></li>
        </ul>
        <!--DROPDOWN MENU-->
    ...
    <div :class="dropdownopen ? 'dropdown open' : 'dropdown closed'" v-if="screenWidth <= 700">
      <div v-if="inStore && dropdownopen" class="dropdownMenu">
        ...
        <router-link v-if="!visible" to="/cart">Korpa</router-link>
